...
from src.fast_forward_interface.FfiException import FfiException

# HACK: replace this
LIBRARY_LOCATION = "/Users/karimstekelenburg/Developer/animo/projects/cwu-bbs+/bbs-wrapper-workspace/ffi-bbs-signatures/target/debug/"
...
def _load_library(lib_name: str):
    ...
    try:
        ...
        lib_path = os.path.join(LIBRARY_LOCATION, f"{lib_prefix}{lib_name}{lib_suffix}")
